...
const Reports = () => {
  ...
  const performanceData = {
    labels: ['Excellent (90-100%)', 'Good (80-89%)', 'Average (70-79%)', 'Poor (60-69%)', 'Very Poor (<60%)'],
    datasets: [
      {
        data: [35, 28, 20, 12, 5],
        backgroundColor: [
  ...
  const handleExportReport = async (format = 'csv') => {
    try {
      await reportService.exportAttendanceReport(format, {
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-green-600">{stats.averageAttendance.toFixed(1)}%</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="h-64">
            <Line data={attendanceTrendsData} options={attendanceTrendsOptions} />
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="h-80">
          <Bar data={weeklyPerformanceData} options={weeklyPerformanceOptions} />
        </div>
      </div>
                  ...
                  <tr key={report.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {report.status === 'Ready' && report.downloadUrl ? (
                        ...
                        <span className="text-gray-400 cursor-not-allowed">Pending</span>
                      )}
                    </td>
                  </tr>
                ))
                ...
                <tr>
                  <td colSpan="5" className="px-6 py-8 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm text-gray-400">Generate your first report by clicking the export button above</p>
                    </div>
                  </td>
                </tr>
              )}
